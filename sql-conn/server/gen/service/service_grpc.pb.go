...
type UserServiceClient interface {
	ListUser(ctx context.Context, in *ListUserReq, opts ...grpc.CallOption) (*ListUserRes, error)
}
...
func (c *userServiceClient) ListUser(ctx context.Context, in *ListUserReq, opts ...grpc.CallOption) (*ListUserRes, error) {
	out := new(ListUserRes)
...
type UserServiceServer interface {
	ListUser(context.Context, *ListUserReq) (*ListUserRes, error)
...
func (UnimplementedUserServiceServer) ListUser(context.Context, *ListUserReq) (*ListUserRes, error) {
